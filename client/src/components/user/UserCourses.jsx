...
export const UserCourses = () => {
    ...
    useEffect(()=> {
        const fun = async()=> {
            try{
                const cou= await axios.get(`${PORT_LINK}/users/courses`, {headers:{Authorization:`Bearer ${localStorage.getItem('tokenUser')}`}})
  ...
  return (
    <div>
        <Typography variant={"h4"} style={{display:"flex", justifyContent:"center", margin:30}} >Courses to Purchase</Typography>
